    ...
    <section className="bg-slate-950 py-16 lg:py-24 text-white border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="px-3.5 py-1.5 rounded-full bg-cyan-950 text-cyan-400 border border-cyan-800 font-bold text-xs uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {steps.map((item, index) => {
            ...
            return (
              <div 
                key={index}
                className="bg-slate-900 border border-slate-800 rounded-3xl p-8 relative flex flex-col justify-between hover:border-cyan-500/50 transition-all group"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-4xl font-black text-slate-800 group-hover:text-cyan-900/60 transition-colors">
                      {item.step}
                    </span>
                ...
                <div className="mt-6 pt-4 border-t border-slate-800 flex items-center text-xs text-cyan-400 font-semibold group-hover:translate-x-1 transition-transform">
        ...
        <div className="mt-12 text-center flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white font-extrabold text-sm shadow-xl transition-all"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-slate-800 hover:bg-slate-700 text-cyan-300 border border-cyan-500/30 font-bold text-sm transition-all"
          >
