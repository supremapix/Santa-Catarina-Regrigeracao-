...
export const RepairsSection: React.FC = () => {
  ...
  return (
    <section className="bg-slate-950 py-16 lg:py-24 text-white border-b border-slate-800" id="reparos">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm shadow-lg transition-all"
            >
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {repairsList.map((repair, idx) => {
              ...
              return (
                <div key={idx} className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-cyan-500/40 transition-colors space-y-2">
                  ...
                  <h3 className="font-bold text-white text-base pt-1">{repair.title}</h3>
                  <p className="text-slate-400 text-xs leading-relaxed">{repair.description}</p>
                </div>
              );
            })}
          </div>
